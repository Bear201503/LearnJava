...
public class AddEvenIntegers {
    ...
    public void sumOfAllEvenIntegers(int userInput){

        System.out.println("sumOfAllEvenIntegers");

        int numberofloops = userInput/2;
    ...
    public static void main(String[] args) {
        ...
        AddEvenIntegers esha2 = new AddEvenIntegers(); // Creating an object

        while(checkUserInput) {
            System.out.println("Please enter a number");
             number = scan.nextInt();
            System.out.println(" the number you chose is " + number);
            checkUserInput = esha2.validateUserInput(number); //Call the method
            System.out.println("checkUserInput : " + checkUserInput);
        }

        esha2.sumOfAllEvenIntegers(number);
